...
export default function CardProduct({ isA11y }: CardProductProps) {
      ...
      <div className="pt-6">
        <div className="mb-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center justify-end gap-1">
            <Button
              ...
              variant="ghost"
              iconOnly={true}
              onClick={() => alert('clicked quick look')}>
              {isA11y && <span className="sr-only"> Quick look </span>}
              <svg
                className="h-5 w-5"
                aria-hidden="true"
            ...
            <Button
              ...
              variant="ghost"
              iconOnly={true}
              onClick={() => alert('clicked add to Favorites')}>
          ...
          <li className="flex items-center gap-2">
            <svg
              ...
              <path
                ...
                strokeLinecap="round"
                strokeWidth="2"
                d="M8 7V6c0-.6.4-1 1-1h11c.6 0 1 .4 1 1v7c0 .6-.4 1-1 1h-1M3 18v-7c0-.6.4-1 1-1h11c.6 0 1 .4 1 1v7c0 .6-.4 1-1 1H4a1 1 0 0 1-1-1Zm8-3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"></path>
            </svg>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
              Best Price
            </p>
        ...
        <div className="mt-4 flex items-center justify-between gap-4">
          ...
          <Button
            isA11y={isA11y}
            variant="ghost"
            onClick={() => alert('clicked add to cart')}>
            <svg
              ...
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M4 4h1.5L8 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm.75-3H7.5M11 7H6.312M17 4v6m-3-3h6"></path>
            </svg>
